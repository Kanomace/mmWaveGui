...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, pred_len, 
        ...
        # Encoding
        self.enc_embedding = DataEmbedding(enc_in, d_model, embed, freq, dropout, has_rope = has_rope)
        self.dec_embedding = DataEmbedding(dec_in, d_model, embed, freq, dropout, has_rope = has_rope)
        # Attention
        ...
        self.projection = nn.Linear(d_model * seq_len//2, num_class)
